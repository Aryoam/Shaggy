var Shout = (function() {
    ...
    Shout.prototype.getshouts = function(callback){
        return this.taringa.request('http://api.taringa.net/shout/public/view', function(err,response,body){
            if(err)
    ...
    Shout.prototype.karma = function (user){
       var self;
        self = this;
    return this.taringa.request.post('http://www.taringa.net/ajax/user/block', {     
    form: {
        key: self.taringa.user_key,
        user: 4247
    }
